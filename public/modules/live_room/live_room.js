...
define(['router'],function(router){
    ...
    function LiveRoom(){
         ...
         * 初始化底部工具栏位置
         */
        this.initToolsPosition = function(){
            var $fav = $(".favorite"),
...
//                window.location.hash = "#publish";
    ...
    globalVar.modules['live_room'] = new LiveRoom().init();
});