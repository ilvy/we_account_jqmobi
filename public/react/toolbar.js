...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonGroup = React.createClass({
								...
								handleEndEvent: function handleEndEvent() {
															// alert(666);
															console.log("end");
								},
								...
								render: function render() {
															...
															return React.createElement("input", { type: "button", value: this.props.value, onClick: this.handleClick, onTouchStart: this.handleTapEvent, onTouchEnd: this.handleEndEvent });
								}
	});
	...
	ReactDOM.render(React.createElement(Toolbar, { name: "toolbar", items: ["购买列表", "收款列表", "历史账单"] }), document.getElementById("toolbar-wrap"));
